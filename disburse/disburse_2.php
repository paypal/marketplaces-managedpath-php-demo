<?php
	...
	if ($captureID === NULL) {
		...
		//Call Disburse API
		$status = buildAndProcessDisburseCall($access_token, $captureID, $disburseRequestData);
...
?>
		...
		<script>
			...
			$(document).ready(function() {					
				...
				overviewGrayoutHighlight("#icon-disburse"); // Disburse
				overviewDefault("#icon-refund"); // Refund
			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="divBorder" style="min-height: 470px;">
						...
						<h4 style="margin-left:50px;"> Disburse API call completed.</h4>
					</div>
				</div>
